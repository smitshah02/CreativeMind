...
<nav class="nav navbar-expand navbar-fixed-top my-navbar">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse navHeaderCollapse">
      ...
      <form class="navbar-form navbar-left" action="Catalogue.php" >
          ...
          if ($result->num_rows > 0)
          {
              while($row=$result->fetch_assoc())
              {
                 switch($row['pcategory'])
                  {
                    case 1:
                      $qty= "<div class='form-group'><select id='quantity' class='form-control' name='quantity'><option value='1'selected>Quantity:1</option><option value='2'>Quantity:2</option><option value='3'>Quantity:3</option><option value='4'>Quantity:4</option><option value='5'>Quantity:5</option></select></div>";                     
                       break;
                    case 2:
                      $qty= "<div class='form-group'><select id='quantity' class='form-control' name='quantity'><option value='1'selected>Quantity:1</option><option value='2'>Quantity:2</option><option value='3'>Quantity:3</option><option value='4'>Quantity:4</option><option value='5'>Quantity:5</option></select></div>";
                        break;
